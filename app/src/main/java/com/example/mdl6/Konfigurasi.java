package com.example.mdl6;

public class Konfigurasi {
    //PENTING! JANGAN LUPA GANTI IP SESUAI DENGAN IPKOMPUTER DIMANA DATA PHP BERADA
    public static final String URL_ADD = "http://192.168.100.34/modul6/insert.php";
    public static final String URL_GET_ALL = "http://192.168.100.34/modul6/read.php";
    public static final String URL_GET_MHS = "http://192.168.100.34/modul6/select.php?id=";
    public static final String URL_UPDATE_MHS = "http://192.168.100.34/modul6/update.php";
    public static final String URL_DELETE_MHS = "http://192.168.100.34/modul6/delete.php?id=";
